...
{
    public partial class matchInfoByNumber : Form
    {
        String eventKey;

        public matchInfoByNumber(String eventKey)
        {
            InitializeComponent();
            this.eventKey = eventKey;
        }

        private int getMatchNumber() { return Convert.ToInt32(matchNumNumericUpDown.Value); }
        ...
        private void matchNumNumericUpDown_ValueChanged(object sender, EventArgs e)
        {
            String t2BoxText = "Teams: ";
            t2BoxText += System.Environment.NewLine;
            t2BoxText += "Red Alliance: ";
            String[][] matchAllianceTeams = getMatchAllianceTeams(getMatchNumber());
            ...
            int[] scores = getMatchScores(getMatchNumber());
